...
% Weird Current Biology rules about times and single line spacing
\linespread{1}
\usepackage{times}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[width=\linewidth]{figures/top25.moveWhaleA_TL2.eps}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[width=\linewidth]{figures/top25.moveWhaleB_TL2.eps}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[width=\linewidth]{figures/top25.moveWhaleC_TL2.eps}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[width=\linewidth]{figures/top25.moveWhaleD_TL2.eps}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[width=\linewidth]{figures/top10.moveWhaleE_TL2.eps}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[width=\linewidth]{figures/top25.moveWhaleF_TL2.eps}
