...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[angle = 90, origin = c, scale = 0.65]{figures/top25.moveWhaleA_TL2.pdf}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[width=\linewidth, scale = 0.55]{figures/top25.moveWhaleB_TL2.pdf}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[angle = 90, origin = c, scale = 0.65]{figures/top25.moveWhaleC_TL2.pdf}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[angle = 90, origin = c, scale = 0.65]{figures/top25.moveWhaleD_TL2.pdf}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[angle = 90, origin = c, scale = 0.65]{figures/top10.moveWhaleE_TL2.pdf}
...
\begin{landscape}
    \begin{figure}[!htbp]
    \centering
      \includegraphics[angle = 90, origin = c, scale = 0.65]{figures/top25.moveWhaleF_TL2.pdf}
