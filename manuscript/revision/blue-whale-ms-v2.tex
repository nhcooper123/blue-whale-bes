...
We simulated 1049 individual movement patterns and compared the resulting simulated baleen $\delta^{13}$C records to the measured records with simple linear regressions. 
There are 1049 simulations because we ran 1500 simulations, then excluded simulations where the virtual whale stranded before reaching the 3019 days represented in the baleen record.
...
We simulated whale movements 1500 times, then excluded simulations where the virtual whale stranded before reaching the 3019 days of the baleen record, leaving 1049 simulations.
